...
const translations: Record<Locale, Record<string, string>> = {
  sr: {
    ...
    "offline.banner": "Offline: dostupni su samo preuzeti sadržaji",
    "offline.not_downloaded": "Nije preuzeto",
    ...
    "viewer.sidebar_collapse": "Sakrij panel",
    "viewer.sidebar_expand": "Prikaži panel",
    ...
    "viewer.find_count_fmt": "{index}/{n} · str. {page}",
    ...
    // Search palette
    "palette.open": "Pretraga (⌘K)",
    "palette.placeholder": "Pretraži predmete, materijale, dokumente…",
    "palette.placeholder_subject": "Pretraži u predmetu…",
    "palette.placeholder_material": "Pretraži u dokumentu…",
    "palette.scope_all": "Sve",
    "palette.scope_subject": "Predmet",
    "palette.scope_material": "Materijal",
    "palette.pick_subject": "Izaberi predmet…",
    "palette.pick_material": "Izaberi materijal…",
    ...
    "palette.hits_fmt": "{n} pogodaka",
    "palette.hits_one": "1 pogodak",
    "palette.load_more": "Učitaj još",
    "palette.footer_hits_fmt": "{hits} pogodaka u {materials} materijala",
    "palette.footer_hits_in_one": "{hits} pogodaka u 1 materijalu",
    "palette.error": "Greška pri pretrazi dokumenata.",
    "palette.more_pages": "još stranica",
  },
  ...
  en: {
    ...
    "offline.available": "Offline",
    "offline.banner": "Offline: only downloaded content is available",
    ...
    "viewer.sidebar_collapse": "Hide panel",
    "viewer.sidebar_expand": "Show panel",
    ...
    "viewer.find_count_fmt": "{index}/{n} · p. {page}",
    ...
    "palette.open": "Search (⌘K)",
    "palette.placeholder": "Search subjects, materials, documents…",
    "palette.placeholder_subject": "Search within subject…",
    "palette.placeholder_material": "Search within document…",
    "palette.scope_all": "All",
    "palette.scope_subject": "Subject",
    "palette.scope_material": "Material",
    "palette.pick_subject": "Choose a subject…",
    "palette.pick_material": "Choose a material…",
    "palette.section_subjects": "Subjects",
    "palette.section_materials": "Materials & Exams",
    "palette.section_content": "In documents",
    "palette.section_offline": "Offline",
    "palette.content_loading": "Searching documents…",
    "palette.content_empty": "No matches in documents.",
    "palette.no_results": "No results.",
    "palette.hits_fmt": "{n} hits",
    "palette.hits_one": "1 hit",
    "palette.load_more": "Load more",
    "palette.footer_hits_fmt": "{hits} hits in {materials} materials",
    "palette.footer_hits_in_one": "{hits} hits in 1 material",
    "palette.error": "Document search failed.",
    "palette.more_pages": "more pages",
  },
}
