...
const translations: Record<Locale, Record<string, string>> = {
  sr: {
    ...
    "palette.placeholder_scope": "Pretraži u {scope}…",
    ...
    "palette.ocr_toggle": "Uključi skenove (OCR)",
    "palette.ocr_note": "Skenirani materijali možda nisu precizno prepoznati",
  ...
  en: {
    ...
    "palette.placeholder_scope": "Search within {scope}…",
    ...
    "palette.ocr_toggle": "Include scans (OCR)",
    "palette.ocr_note": "Scanned materials may not be recognized precisely",
